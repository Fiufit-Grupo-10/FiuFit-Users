...
@router.post("/users", response_model=schemas.UserReturn, status_code=status.HTTP_201_CREATED)
...
@router.delete("/users/{user_id}/followers/{follower_id}", status_code=status.HTTP_200_OK)
...
@router.get("/users/{user_id}/followers", response_model=list[str], status_code=status.HTTP_200_OK)
...
@router.get("/users/{user_id}/following", response_model=list[str], status_code=status.HTTP_200_OK)
...
@router.put("/users/{user_id}", response_model=schemas.UserReturn,status_code=status.HTTP_200_OK)
...
@router.patch("/users", response_model=list[schemas.UserReturn], status_code=status.HTTP_200_OK)
...
@router.get("/users/{user_id}", response_model=schemas.UserReturn,status_code=status.HTTP_200_OK)
...
@router.get("/users", response_model=list[schemas.UserReturn], status_code=status.HTTP_200_OK)
def get_users(
